...
class AttendeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendee" do
    assert_difference('Attendee.count') do
      post attendees_url, params: { attendee: { event_id: @attendee.event_id, event_type: @attendee.event_type, status: @attendee.status, volunteer_id: @attendee.volunteer_id } }
    end
  ...
  test "should update attendee" do
    patch attendee_url(@attendee), params: { attendee: { event_id: @attendee.event_id, event_type: @attendee.event_type, status: @attendee.status, volunteer_id: @attendee.volunteer_id } }
